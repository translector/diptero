...
class Container_a15c0df4cc extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_a15c0df4cc $container)
			{
	...
	public function createServiceContainer(): Container_a15c0df4cc
	{
		return $this;
	}

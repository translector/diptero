...
class Container_fd02a7b332 extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_fd02a7b332 $container)
			{
	...
	public function createServiceContainer(): Container_fd02a7b332
	{
		return $this;
	}

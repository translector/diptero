...
class Container_1084fe25a5 extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_1084fe25a5 $container)
			{
	...
	public function createServiceContainer(): Container_1084fe25a5
	{
		return $this;
	}

...
class Container_8f0f62d2ed extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_8f0f62d2ed $container)
			{
	...
	public function createServiceContainer(): Container_8f0f62d2ed
	{
		return $this;
	}

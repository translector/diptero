...
class Container_ef6e5868e9 extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_ef6e5868e9 $container)
			{
	...
	public function createServiceContainer(): Container_ef6e5868e9
	{
		return $this;
	}

...
class Container_734434a907 extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_734434a907 $container)
			{
	...
	public function createServiceContainer(): Container_734434a907
	{
		return $this;
	}

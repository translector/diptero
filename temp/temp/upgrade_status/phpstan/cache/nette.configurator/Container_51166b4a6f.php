...
class Container_51166b4a6f extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_51166b4a6f $container)
			{
	...
	public function createServiceContainer(): Container_51166b4a6f
	{
		return $this;
	}

...
class Container_a0d65b877b extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_a0d65b877b $container)
			{
	...
	public function createServiceContainer(): Container_a0d65b877b
	{
		return $this;
	}

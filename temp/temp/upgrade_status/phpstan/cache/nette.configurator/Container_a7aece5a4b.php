...
class Container_a7aece5a4b extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_a7aece5a4b $container)
			{
	...
	public function createServiceContainer(): Container_a7aece5a4b
	{
		return $this;
	}

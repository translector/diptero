...
class Container_7c88fe6f6c extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_7c88fe6f6c $container)
			{
	...
	public function createServiceContainer(): Container_7c88fe6f6c
	{
		return $this;
	}

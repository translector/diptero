...
class Container_b6b5a7afb9 extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_b6b5a7afb9 $container)
			{
	...
	public function createServiceContainer(): Container_b6b5a7afb9
	{
		return $this;
	}

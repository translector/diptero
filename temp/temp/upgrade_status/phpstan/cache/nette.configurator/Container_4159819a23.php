...
class Container_4159819a23 extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_4159819a23 $container)
			{
	...
	public function createServiceContainer(): Container_4159819a23
	{
		return $this;
	}

...
class Container_5b5b23e399 extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'analysedPaths' => ['/var/www/html/web/modules/contrib/webform_layout_container'],
	...
	public function createService028(): PHPStan\Analyser\ResultCache\ResultCacheManager
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheManager(
			...
			['/var/www/html/web/modules/contrib/webform_layout_container'],
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_5b5b23e399 $container)
			{
	...
	public function createServiceContainer(): Container_5b5b23e399
	{
		return $this;
	}

...
// source: phar:///var/www/html/vendor/phpstan/phpstan/phpstan/src/PhpDoc/../../conf/config.stubValidator.neon
// source: array
...
class Container_d02a77eca9 extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\PhpDoc\StubSourceLocatorFactory' => [['0172']],
	];
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'additionalConfigFiles' => [
				...
				'phar:///var/www/html/vendor/phpstan/phpstan/phpstan/src/PhpDoc/../../conf/config.stubValidator.neon',
			],
			'analysedPaths' => ['/var/www/html/web/modules/contrib/bg_image_formatter'],
	...
	public function createService028(): PHPStan\Analyser\ResultCache\ResultCacheManager
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheManager(
			...
			['/var/www/html/web/modules/contrib/bg_image_formatter'],
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_d02a77eca9 $container)
			{
	...
	{
		return new PHPStan\Rules\FunctionCallParametersCheck($this->getService('084'), false, false, false, true);
	}


	public function createService072(): PHPStan\Rules\FunctionDefinitionCheck
	{
		return new PHPStan\Rules\FunctionDefinitionCheck($this->getService('reflectionProvider'), $this->getService('068'), true, false);
	}
	...
	public function createService0172(): PHPStan\PhpDoc\StubSourceLocatorFactory
	{
	...
	public function createServiceContainer(): Container_d02a77eca9
	{
		return $this;
	}
	...
	public function createServiceNodeScopeResolverClassReflector(): _HumbugBox69342eed62ce\Roave\BetterReflection\Reflector\ClassReflector
	{
	...
	{
		return new PHPStan\File\FuzzyRelativePathHelper('/var/www/html/web', ['/var/www/html/web/modules/contrib/bg_image_formatter']);
	}
	...
	public function createServiceStubClassReflector(): _HumbugBox69342eed62ce\Roave\BetterReflection\Reflector\ClassReflector
	{
		return new _HumbugBox69342eed62ce\Roave\BetterReflection\Reflector\ClassReflector($this->getService('stubSourceLocator'));
	}


	public function createServiceStubConstantReflector(): _HumbugBox69342eed62ce\Roave\BetterReflection\Reflector\ConstantReflector
	{
		return new _HumbugBox69342eed62ce\Roave\BetterReflection\Reflector\ConstantReflector(
	...
	public function createServiceStubFunctionReflector(): _HumbugBox69342eed62ce\Roave\BetterReflection\Reflector\FunctionReflector
	{
		return new _HumbugBox69342eed62ce\Roave\BetterReflection\Reflector\FunctionReflector(
			$this->getService('stubSourceLocator'),
			$this->getService('stubClassReflector')
		);
	}
	...
	public function createServiceStubSourceLocator(): _HumbugBox69342eed62ce\Roave\BetterReflection\SourceLocator\Type\SourceLocator
	{

...
class Container_8bcaeca766 extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'analysedPaths' => ['/var/www/html/web/modules/contrib/admin_toolbar'],
	...
	public function createService028(): PHPStan\Analyser\ResultCache\ResultCacheManager
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheManager(
			...
			['/var/www/html/web/modules/contrib/admin_toolbar'],
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_8bcaeca766 $container)
			{
	...
	public function createServiceContainer(): Container_8bcaeca766
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\FuzzyRelativePathHelper('/var/www/html/web', ['/var/www/html/web/modules/contrib/admin_toolbar']);
	}

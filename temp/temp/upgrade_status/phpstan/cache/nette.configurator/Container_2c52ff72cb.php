...
class Container_2c52ff72cb extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'analysedPaths' => ['/var/www/html/web/modules/contrib/redirect_after_login'],
	...
	public function createService028(): PHPStan\Analyser\ResultCache\ResultCacheManager
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheManager(
			...
			['/var/www/html/web/modules/contrib/redirect_after_login'],
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_2c52ff72cb $container)
			{
	...
	public function createServiceContainer(): Container_2c52ff72cb
	{
		return $this;
	}

...
class Container_2cb87bb58e extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_2cb87bb58e $container)
			{
	...
	public function createServiceContainer(): Container_2cb87bb58e
	{
		return $this;
	}

...
class Container_52b902fd5d extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_52b902fd5d $container)
			{
	...
	public function createServiceContainer(): Container_52b902fd5d
	{
		return $this;
	}

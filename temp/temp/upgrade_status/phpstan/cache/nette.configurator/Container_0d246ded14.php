...
class Container_0d246ded14 extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_0d246ded14 $container)
			{
	...
	public function createServiceContainer(): Container_0d246ded14
	{
		return $this;
	}

...
class Container_d678b7ede0 extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'analysedPaths' => ['/var/www/html/web/modules/contrib/jquery_ui_datepicker'],
	...
	public function createService028(): PHPStan\Analyser\ResultCache\ResultCacheManager
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheManager(
			...
			['/var/www/html/web/modules/contrib/jquery_ui_datepicker'],
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_d678b7ede0 $container)
			{
	...
	public function createServiceContainer(): Container_d678b7ede0
	{
		return $this;
	}

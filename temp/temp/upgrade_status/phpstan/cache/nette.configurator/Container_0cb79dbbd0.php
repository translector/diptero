...
class Container_0cb79dbbd0 extends _HumbugBox69342eed62ce\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService047(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_0cb79dbbd0 $container)
			{
	...
	public function createServiceContainer(): Container_0cb79dbbd0
	{
		return $this;
	}
